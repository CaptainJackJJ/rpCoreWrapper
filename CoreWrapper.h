...
namespace CoreWrapper 
{
  ...
  public ref class ICoreCallback
  {
  public:
  ...
  {
  public:
    static ICoreCallback^ m_CoreCallback;
  };
  ...
  public:
    static bool LoadLib(String^ strRuntimesPath,String^ strLogPath,String^ strTempPath, ICoreCallback^ callback);
